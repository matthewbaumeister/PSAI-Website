      ...
      <div className="container">
        <div className="page-header">
          ...
          <p className="subtitle">
            ...
            fighting for the underdogs and leveling the playing field against the giants who win based on 
            who they know, not what they can do.
          </p>
        </div>
        ...
        <div className="hero-section">
          <div className="hero-content">
            ...
            <p>
              In a world where the rich get richer and the connected stay connected, we're taking from 
              the procurement giants and giving to the underdogs. We believe that every company, regardless 
              of size or connections, deserves a fair shot at government contracts.
            </p>
        ...
        <div className="content-section">
          <h2>The Problem: The Rich Get Richer</h2>
          <div className="problem-description">
            <div className="problem-text">
              <p>
                Government contracting has become a rigged game where the same big companies win over and over again. 
                They don't win because they're the best or most innovative. They win because they have the right 
                connections, the biggest lobbying budgets, and the deepest pockets to maintain their advantage.
              </p>
              <p>
                Meanwhile, innovative small businesses, veteran-owned companies, women-owned businesses, and 
                minority-owned enterprises struggle to even get a seat at the table. They're shut out not because 
                they lack capability, but because they lack the "right" relationships and the resources to navigate 
        ...
        <div className="content-section">
          <h2>Our Mission: Steal from the Rich, Give to the Deserving</h2>
          <div className="mission-content">
            <div className="mission-text">
              <h3>We're Taking Back Government Contracting</h3>
              <p>
                ...
                technology to level the playing field and give underdogs the tools they need to compete with the giants.
              </p>
              <p>
                Like Robin Hood stealing from the rich to give to the poor, we're taking the advantages that big 
                companies have hoarded for themselves and making them available to everyone. We're democratizing 
                access to government contracting intelligence, tools, and opportunities.
              </p>
            </div>
            <div className="mission-principles">
              <div className="principle">
                <h4>🏹 Merit Over Connections</h4>
                <p>We believe contracts should be won based on capability, not cronyism</p>
              </div>
              <div className="principle">
              ...
              <div className="principle">
                ...
                <p>We reward creativity and innovation over deep pockets</p>
              </div>
              <div className="principle">
        ...
        <div className="content-section">
          <h2>How We're Fighting for the Underdogs</h2>
          <div className="fighting-methods">
            <div className="method">
              <div className="method-icon">🔍</div>
              <h3>Democratizing Intelligence</h3>
              <p>
                Big companies have teams of analysts and expensive market intelligence tools. We're making 
            ...
            <div className="method">
              ...
              <p>
                ...
                big companies spend millions developing in-house.
              </p>
            </div>
            <div className="method">
              <div className="method-icon">📊</div>
              ...
              <p>
                ...
                opportunities that big companies try to keep hidden.
              </p>
            </div>
            <div className="method">
              ...
              <p>
                Big companies have entire proposal departments. We're providing PhD-level writing 
            ...
            <div className="method">
              ...
              <p>
                ...
                and fight back against the procurement giants together.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="content-section">
          <h2>The Underdogs We're Fighting For</h2>
          <div className="underdog-categories">
            <div className="underdog-category">
              <h3>Small Businesses</h3>
              <p>Companies with innovative ideas but limited resources to compete with the giants</p>
            </div>
            <div className="underdog-category">
            ...
            <div className="underdog-category">
              ...
              <p>Female entrepreneurs fighting against systemic barriers in government contracting</p>
            </div>
            <div className="underdog-category">
        ...
        <div className="content-section">
          <h2>Our Robin Hood Team</h2>
          <div className="team-section">
            <div className="team-intro">
              <p>
                We're a team of government contracting rebels, technology innovators, and business 
                revolutionaries who believe that the best companies should win, regardless of their size 
                or connections. We've seen the system from the inside and we're determined to change it.
              </p>
            </div>
        ...
        <div className="content-section">
          ...
          <div className="join-rebellion">
            <div className="rebellion-text">
              <h3>Are You Ready to Fight Back?</h3>
              <p>
                The government contracting giants have had it their way for too long. It's time for the 
                underdogs to rise up and claim their fair share of government contracts. With Prop Shop AI 
                on your side, you'll have the tools, intelligence, and support you need to compete with 
                the biggest players in the game.
              </p>
              <p>
                Join us in our mission to democratize government contracting. Together, we can level the 
                playing field and ensure that contracts go to the companies that deserve them most - not 
                just the companies that know the right people.
              </p>
            </div>
            <div className="rebellion-actions">
              ...
              <div className="action">
                ...
                <p>Connect with other underdogs fighting the same fight</p>
        ...
        <div className="cta-section">
          <h2>Ready to Join the Underdog Revolution?</h2>
          <p>
            Stop letting the giants win based on connections. Start winning based on capability, 
            innovation, and merit. Prop Shop AI is here to level the playing field.
          </p>
          <div className="cta-buttons">
            <a href="/contact" className="btn btn-primary btn-lg">Join the Fight</a>

                        ...
                        <tr>
                          <td colSpan={7} style={{ 
                            ...
                            <div style={{ color: '#cbd5e1', lineHeight: '1.6' }}>
                              ...
                              {/* Opportunity Actions - For ALL Opportunities */}
                              <div style={{
                                padding: '20px',
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                                  ...
                                  <div>
                                    ...
                                    <p style={{ color: '#cbd5e1', fontSize: '13px', margin: 0 }}>
                                      Access complete opportunity information, Q&A, and historical data
                                    </p>
                                  </div>
                                </div>
                              ...
                              {/* Instructions Section - Only for Active Opportunities with Instructions */}

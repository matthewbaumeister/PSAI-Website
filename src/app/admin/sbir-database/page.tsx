                            ...
                            <div style={{ color: '#cbd5e1', lineHeight: '1.6' }}>
                              ...
                              {record.consolidated_instructions_url && ['Open', 'Prerelease', 'Active'].includes(record.status) && (
                                <div style={{
                                  ...
                                  <h4 style={{ color: '#93c5fd', fontSize: '16px', marginBottom: '12px', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                  ...
                                  {record.instructions_generated_at && (
                                    <p style={{ color: '#94a3b8', fontSize: '12px', marginBottom: '16px', fontStyle: 'italic' }}>
                                      Generated: {new Date(record.instructions_generated_at).toLocaleString()}
                                    </p>
                                  )}
                                  <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                                    <a
                                      href={`/dsip/instructions/${record.topic_number}`}
                                      target="_blank"

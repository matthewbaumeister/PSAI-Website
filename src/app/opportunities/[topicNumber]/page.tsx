          ...
          <div style={{ 
            ...
            {instructionsExpanded && (
              <div style={{ 
                ...
                {/* Regenerate Button - only show when expanded, if instructions exist, and opportunity is active */}
                  ...
                  <div style={{
                    ...
                    <button
                      ...
                      style={{
                        ...
                        gap: '6px',
                        transition: 'all 0.2s',
                        opacity: generatingAnalysis ? 0.5 : 0.8,
                        whiteSpace: 'nowrap'
                      }}
                      onMouseEnter={(e) => {
                      ...
                      onMouseLeave={(e) => {
                        e.currentTarget.style.opacity = generatingAnalysis ? '0.5' : '0.8';
